<template>
  <div class="container_homepage">
    ...
    <!-- Session6 -->
    <div class="session_six">
      <!-- why section -->

      <section class="why_section layout_padding">
        <div class="container">
          <div class="heading_container heading_center">
            <h2 style="color: #3a5553">Why are we different?</h2>
          </div>
          <div class="row">
            <div class="col-md-4">
              <div class="box">
...
.container_homepage .session_one .Big_title {
...
.container_homepage .session_one .Big_title:hover {
  color: var(--primary);
}
.session_two {
  height: 1100px;
...
.session_two .top_coffee .top_one {
  padding: 20px;
  width: 300px;
  height: 400px;
  border-radius: 20px;
...
.session_two .top_coffee .top_one .one_text {
  margin-top: 20px;
}
.session_two .top_coffee .top_one .one_text .one_text_one {
  font-size: 30px;
  font-weight: 400;
}
.session_two .top_coffee .top_one .one_text .one_text_two {
  font-size: 20px;
  color: red;
  margin-top: 8px;
}
.session_two .top_coffee .top_one .one_text .one_text_three {
  font-size: 18px;
  color: var(--text_gray);
  margin-top: 6px;
}
